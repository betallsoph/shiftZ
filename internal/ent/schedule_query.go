...
func (_q *ScheduleQuery) QueryShop() *ShopQuery {
...
func (_q *ScheduleQuery) QueryAssignments() *ScheduleAssignmentQuery {
...
func (_q *ScheduleQuery) QueryVotes() *ScheduleVoteQuery {
...
func (_q *ScheduleQuery) WithShop(opts ...func(*ShopQuery)) *ScheduleQuery {
	query := (&ShopClient{config: _q.config}).Query()
...
func (_q *ScheduleQuery) WithAssignments(opts ...func(*ScheduleAssignmentQuery)) *ScheduleQuery {
	query := (&ScheduleAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ScheduleQuery) WithVotes(opts ...func(*ScheduleVoteQuery)) *ScheduleQuery {
	query := (&ScheduleVoteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *ScheduleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Schedule, error) {
	...
	if query := _q.withShop; query != nil {
		if err := _q.loadShop(ctx, query, nodes, nil,
			func(n *Schedule, e *Shop) { n.Edges.Shop = e }); err != nil {
			return nil, err
		}
	}
	if query := _q.withAssignments; query != nil {
		if err := _q.loadAssignments(ctx, query, nodes,
			func(n *Schedule) { n.Edges.Assignments = []*ScheduleAssignment{} },
			func(n *Schedule, e *ScheduleAssignment) { n.Edges.Assignments = append(n.Edges.Assignments, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withVotes; query != nil {
		if err := _q.loadVotes(ctx, query, nodes,
			func(n *Schedule) { n.Edges.Votes = []*ScheduleVote{} },
			func(n *Schedule, e *ScheduleVote) { n.Edges.Votes = append(n.Edges.Votes, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *ScheduleQuery) loadAssignments(ctx context.Context, query *ScheduleAssignmentQuery, nodes []*Schedule, init func(*Schedule), assign func(*Schedule, *ScheduleAssignment)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(scheduleassignment.FieldScheduleID)
	}
	query.Where(predicate.ScheduleAssignment(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(schedule.AssignmentsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ScheduleQuery) loadVotes(ctx context.Context, query *ScheduleVoteQuery, nodes []*Schedule, init func(*Schedule), assign func(*Schedule, *ScheduleVote)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(schedulevote.FieldScheduleID)
	}
	query.Where(predicate.ScheduleVote(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(schedule.VotesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *ScheduleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withShop != nil {
			_spec.Node.AddColumnOnce(schedule.FieldShopID)
		}
	}
