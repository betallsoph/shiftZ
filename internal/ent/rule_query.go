...
func (_q *RuleQuery) QueryShop() *ShopQuery {
...
func (_q *RuleQuery) WithShop(opts ...func(*ShopQuery)) *RuleQuery {
	query := (&ShopClient{config: _q.config}).Query()
...
func (_q *RuleQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Rule, error) {
	...
	if query := _q.withShop; query != nil {
		if err := _q.loadShop(ctx, query, nodes, nil,
			func(n *Rule, e *Shop) { n.Edges.Shop = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *RuleQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withShop != nil {
			_spec.Node.AddColumnOnce(rule.FieldShopID)
		}
	}
