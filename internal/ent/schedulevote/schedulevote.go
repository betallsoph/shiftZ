...
const (
	// Label holds the string label denoting the schedulevote type in the database.
	Label = "schedule_vote"
	...
	// Table holds the table name of the schedulevote in the database.
	Table = "schedule_votes"
	// ShopTable is the table that holds the shop relation/edge.
	ShopTable = "schedule_votes"
...
// Columns holds all SQL columns for schedulevote fields.
var Columns = []string{
	FieldID,
	FieldShopID,
	FieldScheduleID,
