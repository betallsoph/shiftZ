...
func (_q *EmployeeQuery) QueryShop() *ShopQuery {
...
func (_q *EmployeeQuery) QueryAvailabilityDrafts() *AvailabilityDraftQuery {
...
func (_q *EmployeeQuery) QueryAssignments() *ScheduleAssignmentQuery {
...
func (_q *EmployeeQuery) QueryVotes() *ScheduleVoteQuery {
...
func (_q *EmployeeQuery) QueryReminderDeliveries() *ReminderDeliveryQuery {
...
func (_q *EmployeeQuery) WithShop(opts ...func(*ShopQuery)) *EmployeeQuery {
	query := (&ShopClient{config: _q.config}).Query()
...
func (_q *EmployeeQuery) WithAvailabilityDrafts(opts ...func(*AvailabilityDraftQuery)) *EmployeeQuery {
	query := (&AvailabilityDraftClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EmployeeQuery) WithAssignments(opts ...func(*ScheduleAssignmentQuery)) *EmployeeQuery {
	query := (&ScheduleAssignmentClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EmployeeQuery) WithVotes(opts ...func(*ScheduleVoteQuery)) *EmployeeQuery {
	query := (&ScheduleVoteClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EmployeeQuery) WithReminderDeliveries(opts ...func(*ReminderDeliveryQuery)) *EmployeeQuery {
	query := (&ReminderDeliveryClient{config: _q.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
...
func (_q *EmployeeQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Employee, error) {
	...
	if query := _q.withShop; query != nil {
		if err := _q.loadShop(ctx, query, nodes, nil,
			func(n *Employee, e *Shop) { n.Edges.Shop = e }); err != nil {
			return nil, err
		}
	}
	...
	if query := _q.withAvailabilityDrafts; query != nil {
		if err := _q.loadAvailabilityDrafts(ctx, query, nodes,
			func(n *Employee) { n.Edges.AvailabilityDrafts = []*AvailabilityDraft{} },
			func(n *Employee, e *AvailabilityDraft) {
	...
	if query := _q.withAssignments; query != nil {
		if err := _q.loadAssignments(ctx, query, nodes,
			func(n *Employee) { n.Edges.Assignments = []*ScheduleAssignment{} },
			func(n *Employee, e *ScheduleAssignment) { n.Edges.Assignments = append(n.Edges.Assignments, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withVotes; query != nil {
		if err := _q.loadVotes(ctx, query, nodes,
			func(n *Employee) { n.Edges.Votes = []*ScheduleVote{} },
			func(n *Employee, e *ScheduleVote) { n.Edges.Votes = append(n.Edges.Votes, e) }); err != nil {
			return nil, err
		}
	}
	if query := _q.withReminderDeliveries; query != nil {
		if err := _q.loadReminderDeliveries(ctx, query, nodes,
			func(n *Employee) { n.Edges.ReminderDeliveries = []*ReminderDelivery{} },
			func(n *Employee, e *ReminderDelivery) {
				n.Edges.ReminderDeliveries = append(n.Edges.ReminderDeliveries, e)
			}); err != nil {
			return nil, err
		}
	}
...
func (_q *EmployeeQuery) loadAvailabilityDrafts(ctx context.Context, query *AvailabilityDraftQuery, nodes []*Employee, init func(*Employee), assign func(*Employee, *AvailabilityDraft)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Employee)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(availabilitydraft.FieldEmployeeID)
	}
	query.Where(predicate.AvailabilityDraft(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(employee.AvailabilityDraftsColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EmployeeQuery) loadAssignments(ctx context.Context, query *ScheduleAssignmentQuery, nodes []*Employee, init func(*Employee), assign func(*Employee, *ScheduleAssignment)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(scheduleassignment.FieldEmployeeID)
	}
...
func (_q *EmployeeQuery) loadVotes(ctx context.Context, query *ScheduleVoteQuery, nodes []*Employee, init func(*Employee), assign func(*Employee, *ScheduleVote)) error {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(schedulevote.FieldEmployeeID)
	}
	query.Where(predicate.ScheduleVote(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(employee.VotesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EmployeeQuery) loadReminderDeliveries(ctx context.Context, query *ReminderDeliveryQuery, nodes []*Employee, init func(*Employee), assign func(*Employee, *ReminderDelivery)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[uuid.UUID]*Employee)
	for i := range nodes {
		fks = append(fks, nodes[i].ID)
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(reminderdelivery.FieldEmployeeID)
	}
	query.Where(predicate.ReminderDelivery(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(employee.ReminderDeliveriesColumn), fks...))
	}))
	neighbors, err := query.All(ctx)
	if err != nil {
		return err
...
func (_q *EmployeeQuery) querySpec() *sqlgraph.QuerySpec {
	...
	if fields := _q.ctx.Fields; len(fields) > 0 {
		...
		if _q.withShop != nil {
			_spec.Node.AddColumnOnce(employee.FieldShopID)
		}
	}
